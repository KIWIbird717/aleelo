    ...
    extend: {
      backgroundImage: {
        ...
        "button-gradient-yellow":
          "linear-gradient(180deg, #FEF5C9 0%, #FCC400 100%)",
        "button-gradient-orange":
          "linear-gradient(180deg, #ffd866 0%, #cb6b39 100%)",
        "button-gradient-orange-reverse":
          "linear-gradient(180deg, #cb6b39 0, #ffd866 100%)",
        "button-gradient-turquoise":
          "linear-gradient(180deg, #5db2ac 0%, #336069 100%)",
        "button-gradient-blue":
          "linear-gradient(180deg, #76D9EF 0%, #3A638A 100%)",
        "button-gradient-deep-blue":
          "linear-gradient(180deg, #65AFFF 0%, #335C81 100%)",
        "button-gradient-red":
          "linear-gradient(180deg, #FF896F 0%, #E84855 100%)",
        "button-selected":
          "linear-gradient(90deg, #A1C6CC 0%, #387682 100%)",
        ...
        "gradient-slider": "linear-gradient(180deg, rgba(161, 198, 204, 0.5) 0%, rgba(56, 118, 130, 0.5) 100%)",
      },
      keyframes: {
        gradientMove: {
      ...
      boxShadow: {
        ...
        inputActive: "0px 0px 15px 0px rgba(255, 255, 255, 1), 0px 3px 8px 0px rgba(63, 130, 146, 0.5) inset",
        inputError: '0px 3px 8px rgba(159, 35, 27, 0.5) inset',
        options: "0px 8px 30px 0px #00485F4D",
        checkboxActive: "0px 8px 14px -3px #214E564D, 1px 1px 6px 0px #F1AA13 inset, -4px -4px 10px 0px #CF2F2F66 inset",
        switch: "0px 3px 5px 0px rgba(134, 76, 69, 0.3), 1px 1px 7px 0px rgba(246, 230, 178, 1) inset, -3px -3px 5px 0px rgba(203, 107, 57, 0.3) inset",
        switchChecked: "0px 1px 4px 0px rgba(134, 76, 69, 1) inset",
        switchUnchecked: "0px 1px 4px 0px rgba(0, 0, 0, 0.25) inset",
        switchUncheckedCircle: "0px 3px 5px -1px rgba(120, 136, 154, 0.4), 1px 1px 7px 0px rgba(191, 203, 211, 0.5) inset, -3px -3px 5px 0px #D0DAE1 inset",
        slider: "0px 2px 4px 0px rgba(59, 109, 147, 0.4), 0px 0px 6px 0px rgba(200, 223, 238, 1) inset, -2px -2px 4px 0px rgba(197, 215, 226, 1) inset",
